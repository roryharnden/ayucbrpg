...
function shuffle() {
  ...
  var top = [11, 12, 18, 19, 20, 24, 26, 28, 30, 33, 34, 37, 39, 42, 43, 52, 54];
  var right = [3, 10, 11, 17, 23, 24, 25, 28, 29, 30, 33, 34, 51, 53];
  var bottom = [2, 3, 9, 10, 11, 15, 17, 19, 21, 24, 25, 28, 30, 33, 34, 43, 45];
  var left = [4, 10, 11, 12, 18, 24, 25, 26, 28, 29, 30, 31, 34, 35, 52, 54];
